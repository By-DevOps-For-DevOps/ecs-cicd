...
def lambda_handler(event, context):
    ...
    req = urllib2.Request(os.environ['WEBHOOK'], data, {'Content-Type': 'application/json'})
    urllib2.urlopen(req)
...
def get_stack_update_message(cf_message):
    ...
    message = {
        'icon_emoji': ':cloud:',
        'username': os.environ['DEPLOY_ENVIRONMENT'].upper() + " :: "+os.environ['ENVIRONMENT_NAME'],
    ...
    if os.environ['CHANNEL']:
        message['channel'] = os.environ['CHANNEL']
